...
type SetupProvider = "trello" | "jira" | "asana" | "notion" | "slack";
...
const DEFAULT_INTEGRATIONS: Readonly<Integration[]> = [
	...
	},
	{
		provider: "notion",
		name: "Notion",
		description: "Capture action items in your Notion database",
		isProviderConnected: false,
		logo: NotionIcon,
	},
	{
