...
import type { Meeting, SubscriptionPlan } from "@/db/schema";
...
export const TIERS: Plan[] = [
	{
		...
		features: [
			"10 meetings per billing cycle",
			"30 AI chat messages per billing cycle",
	...
	},
	{
		...
		features: [
			"30 meetings per billing cycle",
			"100 AI chat messages per billing cycle",
			"Meeting transcripts and summaries",
			"Action items extraction",
			"Email Notifications",
			"Priority Support",
	...
	},
	{
		...
		features: [
			"Unlimited meetings per billing cycle",
			"Unlimited AI chat messages per billing cycle",
			"Meeting transcripts and summaries",
			"Action items extraction",
			"Email Notifications",
			"Priority Support",
